...
import com.std.forum.dto.req.XN610138Req;
 ...
 * @history:
 */
public class XN610138 extends AProcessor {

    private ICommentAO commentAO = SpringContextHolder
        .getBean(ICommentAO.class);

    private XN610138Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN610138Req.class);
