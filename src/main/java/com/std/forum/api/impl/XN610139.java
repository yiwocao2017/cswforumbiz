...
import com.std.forum.dto.req.XN610139Req;
 ...
 * @history:
 */
public class XN610139 extends AProcessor {

    private ICommentAO commentAO = SpringContextHolder
        .getBean(ICommentAO.class);

    private XN610139Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN610139Req.class);
