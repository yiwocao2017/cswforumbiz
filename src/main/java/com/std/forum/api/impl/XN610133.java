...
import com.std.forum.dto.req.XN610133Req;
 ...
 * @history:
 */
public class XN610133 extends AProcessor {

    private ICommentAO commentAO = SpringContextHolder
        .getBean(ICommentAO.class);

    private XN610133Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN610133Req.class);
